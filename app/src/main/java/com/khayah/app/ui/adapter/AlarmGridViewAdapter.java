...
public class AlarmGridViewAdapter extends BaseAdapter {
    ...
    public AlarmGridViewAdapter(Activity atx, Context context, ArrayList<Categories> catlist , String typeFaceName) { //
        super();
        mActivity = atx;
        mContext = context;
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.alarm_grid_item, null);//gridview_row //fra_browse_gridview_item
    ...
    public View getFooterView(int position, View convertView,
        ...
        if (row == null) {
            row = mActivity.getLayoutInflater().inflate(R.layout.fragment_progress, parent, false);
        }
